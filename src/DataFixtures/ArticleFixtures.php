...
class ArticleFixtures extends BaseFixture
{
    private static $articletitles = [
        ...
        'Life on Planet Mercury: Tan, Relaxing and Fabolous',
        'Light Speed Travel: Fountain of Youth of Fallacy'
    ];
...
EOF
            ...
            $article->setImage($this->faker->randomElement(self::$articleImages));
